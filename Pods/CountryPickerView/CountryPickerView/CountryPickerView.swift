...
public struct Country: Equatable {
    ...
    public var flag: UIImage {
        UIImage(named: "CountryPickerView.bundle/Images/\(code.uppercased())",
...
public class CountryPickerView: NibView {
    ...
    @IBOutlet public var flagImageView: UIImageView! {
        didSet {
    ...
    @IBOutlet public var countryDetailsLabel: UILabel!
    ...
    public weak var dataSource: CountryPickerViewDataSource?
    ...
    public internal(set) var selectedCountry: Country {
        get {
            _selectedCountry
...
extension CountryPickerView {
    ...
    public func getCountryByName(_ name: String) -> Country? {
        countries.first(where: { $0.name == name })
    }

    public func getCountryByPhoneCode(_ phoneCode: String) -> Country? {
        countries.first(where: { $0.phoneCode == phoneCode })
    }
